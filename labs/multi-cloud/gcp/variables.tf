...
variable "panorama-server" {
  description = "The IP address of the Panorama instance that will be managing the GCP firewalls."
  type        = string
  default     = ""
}

variable "vm-auth-key" {
  description = "The VM Auth Key on the Panorama instance that will be used to authenticate the firewalls on the Panorama."
  type        = string
  default     = ""
}

variable "dgname" {
  description = "The Device Group that will be used to configure the firewalls on GCP."
  type        = string
  default     = ""
}

variable "tplname" {
  description = "The Template Stack that will be used to configure the firewalls on GCP."
  type        = string
  default     = ""
}
